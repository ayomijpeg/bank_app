...
$customerId = isset($_SESSION['customer_id']) ? $_SESSION['id'] : '';

if ($customerId) {
    var_dump($customerId);  // This will output the value of $customerId
    ...
    $transactions = [];
    var_dump($customerId);  // In case customerId is not set, you can still check its value
}
